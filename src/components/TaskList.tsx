...
export default function TaskList() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}> A fazer </Text>
      ...
      <TouchableOpacity className='card bg-blue-400 rounded-md p-4 items-center'>
          <Text className="text text-2xl"> Carregar rota </Text>
      </TouchableOpacity>
    </View>
  );
}
